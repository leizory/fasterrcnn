...
# %%
path = "D:/tensorflow_datasets\downloads\extracted\TAR.pjreddi.com_media_files_VOCtest_6-Nov-2007aDaIji4B3KhFd6hJ0zn6T3Ph5PE10xJDDEhWtWCbSJI.tar\VOCdevkit\VOC2007\JPEGImages"
annot = "D:/tensorflow_datasets\downloads\extracted\TAR.pjreddi.com_media_files_VOCtest_6-Nov-2007aDaIji4B3KhFd6hJ0zn6T3Ph5PE10xJDDEhWtWCbSJI.tar\VOCdevkit\VOC2007\Annotations"
...
def get_data(input_path, path):
    ...
    for idx, xml_file in enumerate(os.listdir(input_path)):
        tree = ET.parse(os.path.join(input_path, xml_file))
        root = tree.getroot()
        filename = root.find('filename').text
        filepath = os.path.join(path, filename)
        # Only keep the filename, remove the path
        ...
        all_data.append([filepath, width, height, bboxes])
...
def nn_base(input_tensor=None, trainable=False):
    ...
    # If we want to set the first 15 layers (up to the last conv block)
...
train_path =  annot # Training data (annotation file)
...
#--------------------------------------------------------#
st = time.time()
train_imgs, classes_count, class_mapping = get_data(train_path, path)
print()
